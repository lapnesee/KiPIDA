...
class EMCPhase10RegionResult:
    ...
    solver_cells: int = 0
    mesh_nodes: int = 0
    requested_mesh_resolution_mm: float = 0.0
    mesh_characteristic_min_mm: float = 0.0
    mesh_characteristic_max_mm: float = 0.0
    estimated_palace_peak_memory_gib: float = 0.0
    omitted_short_track_count: int = 0
    solver_iterations: int = 0
    solver_converged: Optional[bool] = None
    solver_energy_decay_db: Optional[float] = None
    fields_extracted: bool = False
    field_output_count: int = 0
    frequency_hz: float = 0.0
    harmonic_order: int = 0
    source_moment_a_m: float = 0.0
    electric_energy_j: Optional[float] = None
    magnetic_energy_j: Optional[float] = None
    normalized_energy_j_per_a2_m2: Optional[float] = None
    error_indicator_norm: Optional[float] = None
    error_indicator_maximum: Optional[float] = None
    mesh_kappa_maximum: Optional[float] = None
    palace_mesh_h_minimum: Optional[float] = None
    palace_mesh_h_maximum: Optional[float] = None
    solver_unknowns: int = 0
    solver_estimated_memory_gib: Optional[float] = None
    discretization_verified: bool = False
    requested_via_count: int = 0
    modeled_via_count: int = 0
    via_model: str = ""
    via_geometry_fallback: bool = False
